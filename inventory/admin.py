...
class SalesOrderItemInline(admin.TabularInline):
    ...
    extra = 1  # allows one extra blank form

@admin.register(SalesOrder)
class SalesOrderAdmin(admin.ModelAdmin):
    list_display = ['id', 'customer', 'order_date', 'reference_number', 'is_fulfilled', 'created_by', 'updated_by']
...
@admin.register(InventoryProcessType)
